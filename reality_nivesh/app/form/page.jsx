...
import PictureInputPreview from './PictureInputPreview';
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-12 gap-x-6 gap-y-4">
                                {fields?.map(({ isDisabled = false, ...field }, i) => {
                                    ...
                                    return (
                                        <div
                                            className={`${field?.col == 6 ? 'col-span-6' : 'col-span-12'
                                                }`}
                                            key={i}
                                        >
                                            {field?.type === 'line' ? (
                                                                ...
                                                                return (
                                                                    <div className="relative">
                                                                        <Field
                                                                            ...
                                                                            className={`appearance-none block w-full px-4 py-2.5 bg-white text-slate-900 border ${fieldError
    ...
    return (
        <>
            ...
            <div className="relative group">
                <div
                    className={`flex flex-col rounded-lg border-2 border-dashed ${error
                ...
                >
                    <div className="flex flex-col items-center justify-center py-5 px-4 text-center">
                        <svg
                            className={`mb-3 h-10 w-10 ${error
                                    ? 'text-rose-400'
                                    : fileSelected
                                        ? 'text-sky-500'
                                        : 'text-slate-400'
                        ...
                        <div
                            className={`text-sm 2xl:text-base ${error
                                    ? 'text-rose-500'
                                    : fileSelected
                                        ? 'text-sky-600'
                                        : 'text-slate-600'
                        ...
                        <p
                            className={`text-xs ${error ? 'text-rose-500' : 'text-slate-500'
                                }`}
                        >
                        ...
                        {previews.map((src, index) => (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-end justify-center p-2">
                                    <span className="text-white text-xs font-medium">{`Image ${index + 1
                                        }`}</span>
                                </div>
                            </div>
                        ))}
...
const PictureInputSmall = ({
    ...
    return (
        <>
            <label
                className={`inline-flex items-center justify-center p-2 rounded-md border ${selected
...
const TextEditer = ({
    ...
    return useMemo(() => {
        ...
        return (
            <div
                className={`jodit-wrapper rounded-lg overflow-hidden ${error ? 'ring-2 ring-rose-500' : ''
                    }`}
            >
                <JoditEditor
                    ref={editor}
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm 2xl:text-base font-medium">
                                            <div className="flex justify-end gap-2">
                                                <button
                                                    ...
                                                    onClick={() => editFeature(key, feature)}
                                                >
                                                    Edit
                                                </button>
                                                <button
