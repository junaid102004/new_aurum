...
const ContactBarMobile = () => {
  ...
  return (
    ...
    <>
      {isOpen && (
        <div
          className="fixed inset-0 z-40 bg-black bg-opacity-60 backdrop-blur-sm transition-opacity duration-300 sm:hidden"
      ...
      {/* Contact Bar */}
      <div
        className={`w-full fixed bottom-0 left-0 z-50 sm:hidden transition-all duration-500 pb-2 ease-in-out
        ${visible ? "translate-y-0 opacity-100" : "translate-y-full opacity-0"}
      `}
      >

        <div className="relative mx-auto w-full max-w-[461px] xs:px-0  px-1 z-40">
          {/* Background SVG */}
          <svg
            className="w-full"
            viewBox="0 0 461 61"
          ...
          <div className="w-full h-full absolute left-0 bottom-0 flex text-[#000]">
            ...
            <div className="w-1/3 relative pt-5 ml-1 text-center text-[11px] xs:text-[12px] font-semibold tracking-widest flex flex-col justify-center items-center">
              ...
              <button
                ...
                className={`rotate-0 ${isOpen && "rotate-180"} duration-500 flex justify-center items-center w-[55px] xs:w-[62px] h-[55px] xs:h-[62px] absolute bottom-[25px] xs:bottom-[32px] cxs:bottom-[34px] left-[50%] z-50 translate-x-[-55%] rounded-full bg-[#000]`}
              >
              ...
              {isOpen && (
                <>
                  ...
                  <a
                    href="/price"
                    className={`absolute w-[68px] h-[68px] bg-white rounded-full flex flex-col justify-center items-center shadow-lg transition-all duration-500 ${isOpen ? "opacity-100 scale-100" : "opacity-0 scale-0"
                      }`}
                    style={{
                      top: '-220px',
                      left: '-20px',
                  ...
                  >
                    <IndianRupee size={30} className="text-[#a85918] relative mb-1" />
                    <span className="text-[12px]  font-['Supera'] font-bold text-white top-[80px] absolute uppercase tracking-wide">Price</span>
                  </a>
                  ...
                  >
                    <Gift size={30} className="text-[#a85918] mb-1 relative" />
                    <span className="text-[12px]  font-['Supera'] font-bold text-white top-[80px] absolute uppercase tracking-wide text-center leading-tight">Current<br />Offer</span>
                  </a>
                  ...
                  >
                    <Building size={30} className="text-[#a85918] mb-1 relative " />
                    <span className="text-[12px] font-['Supera'] font-bold text-white uppercase absolute top-[80px] tracking-wide">Amenities</span>
                  </a>
                  ...
                  >
                    <Home size={30} className="text-[#a85918] mb-1  relative" />

                    <span className="text-[12px] font-['Supera'] font-bold text-white absolute top-[75px] uppercase tracking-wide text-center leading-tight">Our<br />Products</span>
                  </a>
                </>
              )}
