        ...
        <div className="w-full h-full absolute left-0 bottom-0 flex text-[#000]">
          ...
          <div className="w-1/3 relative pt-5 ml-1 text-center text-[11px] xs:text-[12px] font-semibold tracking-widest flex flex-col justify-center items-center">
            ...
            <button
              ...
              className={`rotate-0 ${isOpen && "rotate-45"} duration-500 flex justify-center items-center w-[55px] xs:w-[62px] h-[55px] xs:h-[62px] absolute bottom-[25px] xs:bottom-[32px] cxs:bottom-[34px] left-[50%] z-50 translate-x-[-55%] rounded-full bg-[#000]`}
            >
